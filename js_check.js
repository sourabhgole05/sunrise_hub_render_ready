...
var S={pl:'in',chans:[],cat:'all',q:'',shown:0,queue:[],busy:0,autoN:0,
 now:{},cache:{},loadToken:0,loadAbort:null,checkAbort:{},sort:'default',liveonly:false};
// Restore persisted sort / live-only toolbar prefs.
...
function playerPlay(){
 ...
 if(playPromise&&playPromise.catch){
  playPromise.catch(function(){
   // Autoplay blocked — let user tap the play button.
   var isMobile=/Android|iPhone|iPad|iPod/i.test(navigator.userAgent);
   $('playerhint').textContent=isMobile
